    ...
    implements ApplicationContainer, ContainerNotifier
{
  ...
  @Override
  protected ResourceConfig getDefaultResourceConfig(final Map<String, Object> props, final WebConfig webConfig)
  ...
  /**
   * Dummy root resource to configure Jersey with so that it can initialize, it needs at least one root resource or
   * it
   * will puke.
   */
