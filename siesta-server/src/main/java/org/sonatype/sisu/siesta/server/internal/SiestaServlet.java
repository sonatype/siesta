    ...
    extends HttpServlet
{
  ...
  {
    public void add(final BeanEntry<Annotation, Application> entry, final ApplicationContainer container)
        throws Exception
    {
    ...
    public void remove(final BeanEntry<Annotation, Application> entry, final ApplicationContainer container)
        throws Exception
    {
      // unsupported
    }
